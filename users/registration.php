...
if(isset($_POST['submit']))
{
	...
	$status=1;
	echo "insert into users(fullName,userEmail,password,contactNo,status) values('$fullname','$email','$password','$contactno','$status')";
...
<html lang="en">
  <head>
    ...
    <title>Women Security System|User Registration</title>
