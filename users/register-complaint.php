...
<select name="complaintype" class="form-control" required="">
				...
				<option value="General Query">Report Crime</option>
                  <option value="General Query">General Query</option>
				  <option value="General Query">Last Action</option>
                </select> 
</div>
...
<div class="col-sm-4">
<select name="state" required="required" class="form-control styled">
...
<div class="col-sm-4">
<select name="station" required="required" class="form-control" id="station">
<option value="">Select Station</option>
<?php $sql=mysqli_query($bd, "select nearStation from state ");
while ($rw=mysqli_fetch_array($sql)) {
  ?>
  <option value="<?php echo htmlentities($rw['station']);?>"><?php echo htmlentities($rw['station']);?></option>
<?php
}
?>
</select>
