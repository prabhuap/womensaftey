...
{
$ret=mysqli_query($bd, "SELECT * FROM police  WHERE policeEmail='".$_POST['username']."' and password='".md5($_POST['password'])."'");
...
$query=mysqli_query($bd, "SELECT * FROM police WHERE policeEmail='$email' and contactNo='$contact'");
...
<html lang="en">
  <head>
    ...
    <title>Women Security System | User Login</title>
