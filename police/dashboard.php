...
$rt = mysqli_query($bd, "SELECT * FROM tblcomplaints where station='".$_SESSION['id']."' and status is null");
...
{?>
                  ...
                  <span class="li_news"></span>
                    <?php 
  $status="in Process";                   
$rt = mysqli_query($bd, "SELECT * FROM tblcomplaints where station='".$_SESSION['id']."' and  status='$status'");
$num1 = mysqli_num_rows($rt);
{?>
                  <h3><?php echo htmlentities($num1);?></h3>
                        </div>
