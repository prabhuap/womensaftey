...
<head>
	...
	<title>Women Security System | Manage Users</title>
...
?>									
										<tr>
											...
											<td><a href="javascript:void(0);" onClick="popUpWindow('http://localhost/Women security system/admin/userprofile.php?uid=<?php echo htmlentities($row['id']);?>');" title="Update order">
